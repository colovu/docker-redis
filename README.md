...
$ docker run -d -e ALLOW_ANONYMOUS_LOGIN=yes --name redis colovu/redis:5.0

# 从 Aliyun 服务器下载镜像并启动
$ docker run -d -e ALLOW_ANONYMOUS_LOGIN=yes --name redis registry.cn-shenzhen.aliyuncs.com/colovu/redis:5.0
```
...
$ curl -sSL -o https://gitee.com/colovu/docker-redis/raw/5.0/docker-compose.yml

# 从 Github 下载 Compose 文件
$ curl -sSL -o https://raw.githubusercontent.com/colovu/docker-redis/5.0/docker-compose.yml
...
```shell
$ curl -sSL -o https://raw.githubusercontent.com/colovu/docker-redis/5.0/docker-compose-cluster.yml
